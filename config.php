...
define('OB_DB_USER', getenv('OB_DB_USER')); // database user
define('OB_DB_PASS', getenv('OB_DB_PASS')); // database password
define('OB_DB_HOST', getenv('OB_DB_HOST')); // database hostname
define('OB_DB_NAME', getenv('OB_DB_NAME')); // database name

define('OB_HASH_SALT', getenv('OB_HASH_SALT')); // change to random characters for password salt.

// make sure the following directories are writable by the web server.
define('OB_MEDIA', getenv('OB_MEDIA'));
define('OB_MEDIA_UPLOADS', getenv('OB_MEDIA_UPLOADS')); // can be subdirectory of OB_MEDIA, but doesn't need to be.
define('OB_MEDIA_ARCHIVE', getenv('OB_MEDIA_ARCHIVE')); // can be subdirectory of OB_MEDIA, but doesn't need to be.
define('OB_THUMBNAILS', getenv('OB_THUMBNAILS'));
define('OB_CACHE', getenv('OB_CACHE'));

define('OB_SITE', getenv('OB_SITE')); // where do you access OB?

define('OB_EMAIL_REPLY', getenv('OB_EMAIL_REPLY')); // emails to users come from this address
define('OB_EMAIL_FROM', getenv('OB_EMAIL_FROM')); // emails to users come from this name
